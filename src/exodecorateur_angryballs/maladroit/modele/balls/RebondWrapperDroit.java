	...
	public RebondWrapperDroit(Bille wrappedBille) {
	 ...
	 @Override
	    public  void collisionContour(double abscisseCoinHautGauche, double ordonneeCoinHautGauche, double largeur, double hauteur) {
		 Collisions2.getInstance().collisionBilleContourAvecRebondDroit(this.getPosition(),this.getRayon(),this.getVitesse(),abscisseCoinHautGauche, ordonneeCoinHautGauche,largeur, hauteur);
