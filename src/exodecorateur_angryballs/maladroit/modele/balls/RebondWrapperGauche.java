	...
	public RebondWrapperGauche(Bille wrappedBille) {
	 ...
	 @Override
	    public  void collisionContour(double abscisseCoinHautGauche, double ordonneeCoinHautGauche, double largeur, double hauteur) {
	       Collisions2.getInstance().collisionBilleContourAvecRebondGauche(this.getPosition(),this.getRayon(),this.getVitesse(),abscisseCoinHautGauche, ordonneeCoinHautGauche,largeur, hauteur);
